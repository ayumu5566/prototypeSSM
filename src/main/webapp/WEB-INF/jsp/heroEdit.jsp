...
<body>
	<div class="panel panel-warning">
		<div class="panel-heading">修改英雄</div>
		<div class="panel-body">
			<form action="update" method="post">
				<input type="hidden" id="id" name="id" value="${hero.id}">
				<div class="div_text">
					<label for="name" class="lable_text">姓名：</label>
					<input type="text" id="name" name="name" value="${hero.name}" class="form-control input_text">
				</div>
				<div class="div_text">
					<label for="hp" class="lable_text">血量：</label>
					<input type="text" id="hp" name="hp" value="${hero.hp}" class="form-control input_text">
				</div>
				<div class="div_text">
					<label for="damage" class="lable_text">攻击：</label>
					<input type="text" id="damage" name="damage" value="${hero.damage}" class="form-control input_text">
				</div>
				<div class="div_text">
